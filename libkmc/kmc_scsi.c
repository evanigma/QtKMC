...
int idcode, dataversion, fps, hsize, vsize, totalFrames, speed, color, trigger, year, month, date, time_hour, time_minute, time_second, sessionid, balance, cp1, cp2, cp3, cp4, cp5, cp6, cp7, cp8, cp9;
...
//    printf("...............vendorinherent: %s\n",vendorinherent);
    ...
    totalFrames = pagestart[102]*256*256 + pagestart[103]*256+pagestart[104];
...
//    totalFrames = 100;
//    printf("changed totalFrames to : %d\n",totalFrames);
    /* End region to be REMOVED. */
